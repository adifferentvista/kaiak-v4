...
**New: HeyGen x Gamma integration.** HeyGen recently [announced an integration with Gamma](https://heygen.noticeable.news/posts/new-heygen-x-gamma-integration), the AI presentation tool. This means you can potentially go from notes to presentation to avatar-narrated video in one pipeline. I haven't tested this yet, but if you're already using [Gamma for presentations](https://try.gamma.app/fhtz3l0yejjl), this could be a powerful workflow. I'll write a full breakdown once I've put it through its paces.
