...
[Claude Projects](https://support.claude.com/en/articles/9517075-what-are-projects) are available on both the free and Pro tiers. Free tier gives you a limited number of projects with lower usage caps. Pro ($20/month) gives you unlimited projects, access to the most capable models, and significantly higher usage limits.
...
| Feature | Free | Pro ($20/mo) | Max (from $100/mo) |
|---|---|---|---|
| Projects | Limited | Unlimited | Unlimited |
| File uploads | Yes | Yes | Yes |
| Custom instructions | Yes | Yes | Yes |
| Models available | Limited | All models | All models + early access |
| Usage limits | Low - you'll hit limits quickly | More usage | 5x or 20x more than Pro |
| Claude Code | No | Yes | Yes |
| Claude Cowork | No | Yes | Yes |
| Research | No | Yes | Yes |
| Priority access | No | No | Yes - at high traffic times |
| Output limits | Standard | Standard | Higher for all tasks |
...
**Not supported (as of early 2026):** Excel (.xlsx) - convert to CSV first. No audio, video, or ZIP files. Check the [Claude Projects documentation](https://support.claude.com/en/articles/9517075-what-are-projects) for the latest supported formats.
...
**I teach context engineering - the skill of building AI environments like this - in depth in my [AI Leadership course](/work-with-me).** Module 2 covers the RCFCC framework, Claude Projects, and [NotebookLM](https://notebooklm.google). If you want the full system, that's where to start.
