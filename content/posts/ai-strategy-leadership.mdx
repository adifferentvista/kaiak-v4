...
description: "AI performs cognitive work—writing, analyzing, evaluating—not just tasks. That makes it a leadership issue, not a technology issue. What only you can decide."
date: "2026-02-13"
pillar: "leadership"
contentType: "evergreen"
readTime: "8 min read"
featured: true
image: "/blog/headers/kaiak-ai-strategy-leadership.webp"
imageAlt: "Illustration for: 60% of principals already use AI. IT can't answer the hard questions."
...
**Teachers feel unsupported.** They navigate complex questions without visible leadership guidance. The [training gap is real](/blog/teacher-ai-training-gap)—over 80% of students say teachers never explicitly taught them how to use AI for schoolwork.
