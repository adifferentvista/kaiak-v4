...
According to the [OECD TALIS 2024 survey](https://oecd.org/en/publications/results-from-talis-2024_90df6235-en), over half of teachers across OECD countries report administrative work as their biggest source of stress - more than any other demand. Australia's admin workload has increased since 2018, and in my experience, a significant portion of that burden is report writing.
...
Before the how-to, you need to understand what goes wrong. Most teachers open ChatGPT or [Claude](https://claude.ai) and type something like:
...
- Match [e.g., "American English," "British English," or "Australian English"] spelling conventions
...
**If you use an LMS, this step is even faster.** Most international schools already have structured assessment data sitting in their learning management system - rubric scores, task-specific feedback, learning outcomes, attendance patterns. That data is exactly what makes AI comments specific instead of generic.

Here's how to pull it depending on your platform:

- **[ManageBac](https://www.managebac.com):** Go to your class → Progress Reports or Gradebook. You can export student assessment data as a CSV, or simply copy the rubric scores and task comments for each student. ManageBac's unit planners also store your ATL (Approaches to Learning) observations - those make excellent input for the prompt's "Observation notes" field.

- **[Toddle](https://www.toddleapp.com):** Navigate to your class portfolio or assessment overview. Toddle stores learning evidence, learning outcome ratings, and teacher reflections per student. Copy the outcome ratings and any written reflections - these feed directly into both the "Assessment data" and "Observation notes" fields in the prompt.

- **[Google Classroom](https://classroom.google.com):** Open your Gradebook for the class. You can see scores per assignment and any private comments you've left on student work. For richer data, check your Google Sheets rubrics if you use them. The scores alone are helpful, but your private comments on their submissions are gold - those are the specific observations that make each comment unique.

The point is the same regardless of platform: **your LMS already has the structured data that makes AI comments good.** Instead of manually typing observation notes from memory, you're copying what you've already recorded throughout the term. "Step 1: Gather your raw notes" becomes "Step 1: Export from your LMS" - faster, more consistent, and more specific.
...
Replace every bracketed section with your actual information. The most important field is **Observation notes** - the quality of your input directly determines the quality of the output. Paste your real notes for the first student. Even rough notes like "Emma - strong reader, needs work on inference questions, loves group work, sometimes rushes written tasks" will produce a dramatically better comment than giving no notes at all.
...
According to [Azumo's AI in the Workplace research](https://azumo.com/artificial-intelligence/ai-insights/ai-in-workplace-statistics), professionals using AI for administrative tasks save an average of 3.5 hours per week. For teachers, that time goes straight back into planning, feedback, and the work that actually matters.
