...
**Step 5.** A text box appears. This is how you describe what you want. Be specific. Instead of "quarterly update," try something like:
...
**Want to build a complete AI toolkit for your leadership practice?** I cover tool selection - when to use which tool for which task - in my [AI Leadership course](https://academy.kaiak.io). No feature tours. Just the practical decisions that save you time every week.
