...
The meeting audit template is included in the [No-Admin Second Brain Guide](/second-brain) — along with the async alternatives that replace unnecessary meetings.
