            ...
            {Object.entries(pillarLabels).map(([key, label]) => {
              ...
              return (
                <Link
                  ...
                  className="p-4 border border-slate-200 dark:border-slate-700 rounded-lg hover:border-slate-300 dark:hover:border-slate-600 transition-colors bg-white dark:bg-slate-800"
                >
                  <h3 className="font-medium text-navy dark:text-white">{label}</h3>
