  ...
  return (
    <div className="min-h-screen bg-cream dark:bg-navy">
      ...
      <main>
        ...
        {/* Four Service Options - Now with Prices */}
        <section className="py-20 md:py-28 text-white bg-navy dark:bg-navy-dark">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <h2 className="font-serif text-3xl md:text-4xl mb-4">Four Ways I Can Help</h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="rounded-2xl p-6 flex flex-col bg-navy-light dark:bg-slate-800 border border-navy-border dark:border-slate-700">
                ...
                <div className="pt-4 border-t border-navy-border dark:border-slate-700">
                  <div className="text-2xl font-bold text-white mb-1">$6,500</div>
              ...
              {[
                {
                  ...
                  a: "Start with a Strategy Session ($297) if you're unsure. If you're drowning in emails and meetings → AI Systems. If you're missing handbooks and policies → School Ops. Not sure? Book a free call and we'll figure it out together."
                },
                {
                ...
                },
                {
                  ...
                  a: "The online course ($147) and Strategy Sessions ($297) are perfect for PD budgets. For larger engagements, many schools categorize it as professional development or operational consulting — I can provide documentation either way."
                }
              ].map((item, i) => (
                <div key={i}>
